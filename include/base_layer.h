...
public:
	...
	virtual QList<GameObject *> getGameObjects() const = 0;
	...
	virtual void snapXCoord(qreal x, qreal y1, qreal y2, const QList<GameObject *> &excludedObjects, qreal &snappedX, qreal &distance, QLineF &line) const = 0;
	...
	virtual void loadTranslations(LuaScript *script) = 0;
